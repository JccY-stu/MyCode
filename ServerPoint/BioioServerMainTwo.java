...
public class BioioServerMainTwo {
    ...
    public static void main(String[] args) throws Exception{
        ...
        ConcurrentHashMap<String,Socket> clientSocketMap = new ConcurrentHashMap<String, Socket>();
        ...
        WriteServer writeServer = new WriteServer(connectedSocketList,clientNameMap,clientSocketMap);
        ...
        while(true){
            ...
            //创建一个新线程 用于 读取数据
            ReadServer readUtil = new ReadServer(socket,connectedSocketList,clientNameMap,clientSocketMap,msgMemoryMap,writeToRedis);
